...
int main(int argc, char *argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    int magic = getMagic();
  11:	e8 b4 03 00 00       	call   3ca <getMagic>
  ...
  21:	e8 6a 04 00 00       	call   490 <printf>
    ...
    incrementMagic(3);
  26:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  2d:	e8 90 03 00 00       	call   3c2 <incrementMagic>

    magic = getMagic();
  32:	e8 93 03 00 00       	call   3ca <getMagic>
    printf(1, "current magic number is the following: %d\n", magic);
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	50                   	push   %eax
  3b:	68 e8 07 00 00       	push   $0x7e8
  40:	6a 01                	push   $0x1
  ...
  47:	58                   	pop    %eax
  48:	5a                   	pop    %edx
  49:	68 14 08 00 00       	push   $0x814
  4e:	6a 01                	push   $0x1
  50:	e8 3b 04 00 00       	call   490 <printf>
    getCurrentProcessName();
  55:	e8 78 03 00 00       	call   3d2 <getCurrentProcessName>
    printf(1, "\n");
  5a:	59                   	pop    %ecx
  5b:	58                   	pop    %eax
  5c:	68 2a 08 00 00       	push   $0x82a
  61:	6a 01                	push   $0x1
  63:	e8 28 04 00 00       	call   490 <printf>

    modifyCurrentProcessName("newName");
  68:	c7 04 24 2c 08 00 00 	movl   $0x82c,(%esp)
  6f:	e8 66 03 00 00       	call   3da <modifyCurrentProcessName>

    printf(1, "current process new name:");
  74:	58                   	pop    %eax
  75:	5a                   	pop    %edx
  76:	68 34 08 00 00       	push   $0x834
  7b:	6a 01                	push   $0x1
  7d:	e8 0e 04 00 00       	call   490 <printf>
    getCurrentProcessName();
  82:	e8 4b 03 00 00       	call   3d2 <getCurrentProcessName>
    printf(1, "\n");
  87:	59                   	pop    %ecx
  88:	58                   	pop    %eax
  89:	68 2a 08 00 00       	push   $0x82a
  8e:	6a 01                	push   $0x1
  90:	e8 fb 03 00 00       	call   490 <printf>

    magic = getMagic();
  95:	e8 30 03 00 00       	call   3ca <getMagic>
    printf(1, "current magic number is the following: %d\n", magic);
  ...
  a5:	e8 e6 03 00 00       	call   490 <printf>
    ...
    incrementMagic(3);
  aa:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  b1:	e8 0c 03 00 00       	call   3c2 <incrementMagic>

    magic = getMagic();
  b6:	e8 0f 03 00 00       	call   3ca <getMagic>
    printf(1, "current magic number is the following: %d\n", magic);
  ...
  c6:	e8 c5 03 00 00       	call   490 <printf>
    ...
    exit();
  cb:	e8 52 02 00 00       	call   322 <exit>
...
000003d2 <getCurrentProcessName>:
SYSCALL(getCurrentProcessName)
 3d2:	b8 18 00 00 00       	mov    $0x18,%eax
 3d7:	cd 40                	int    $0x40
 3d9:	c3                   	ret    

000003da <modifyCurrentProcessName>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 4e 08 00 00       	mov    $0x84e,%ebx
        while(*s != 0){
