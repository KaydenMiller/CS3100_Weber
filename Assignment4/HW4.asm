...
int main(int argc, char *argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    int magic = getMagic();
  11:	e8 74 03 00 00       	call   38a <getMagic>
  ...
  21:	e8 2a 04 00 00       	call   450 <printf>
    ...
    magic = getMagic();
  26:	e8 5f 03 00 00       	call   38a <getMagic>
    printf(1, "current magic number is the following: %d\n", magic);
  2b:	83 c4 0c             	add    $0xc,%esp
  2e:	50                   	push   %eax
  2f:	68 a8 07 00 00       	push   $0x7a8
  34:	6a 01                	push   $0x1
  ...
  3b:	58                   	pop    %eax
  3c:	5a                   	pop    %edx
  3d:	68 d4 07 00 00       	push   $0x7d4
  42:	6a 01                	push   $0x1
  44:	e8 07 04 00 00       	call   450 <printf>

    getCurrentProcessName();
  49:	e8 44 03 00 00       	call   392 <getCurrentProcessName>

    printf(1, "\n");
  4e:	59                   	pop    %ecx
  4f:	58                   	pop    %eax
  50:	68 ea 07 00 00       	push   $0x7ea
  55:	6a 01                	push   $0x1
  57:	e8 f4 03 00 00       	call   450 <printf>
    ...
    getCurrentProcessName();
  5c:	e8 31 03 00 00       	call   392 <getCurrentProcessName>

    magic = getMagic();
  61:	e8 24 03 00 00       	call   38a <getMagic>
    printf(1, "current magic number is the following: %d\n", magic);
  ...
  71:	e8 da 03 00 00       	call   450 <printf>
    ...
    magic = getMagic();
  76:	e8 0f 03 00 00       	call   38a <getMagic>
    printf(1, "current magic number is the following: %d\n", magic);
...
00000392 <getCurrentProcessName>:
SYSCALL(getCurrentProcessName)
 392:	b8 18 00 00 00       	mov    $0x18,%eax
 397:	cd 40                	int    $0x40
 399:	c3                   	ret    

0000039a <modifyCurrentProcessName>:
